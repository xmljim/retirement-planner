...
public record Account(
        Optional<AccountId> id, PlanId planId, AccountType type, OwnerRef owner, List<AccountSleeve> sleeves) {
    ...
    /** Convenience constructor for an unpersisted account. */
    public static Account of(PlanId planId, AccountType type, OwnerRef owner, List<AccountSleeve> sleeves) {
        return new Account(Optional.empty(), planId, type, owner, sleeves);
    }
